...
#define MODE_NO 9         // Defines maximum number of modes
...
uint32_t yellow = pixels.Color(255, 255, 51);
uint32_t cyan = pixels.Color(58, 152, 193);
...
uint8_t brightness = MAXBRIGHTNESS / 2;
